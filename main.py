...
MAX_PRICES = 700
TICK_CONFIRMATION = 3  # 🔥 reduced from 4 → faster entry
...
# ================================
# 🔥 FIX: MID-TREND ENTRY FILTER (NEW)
# ================================
...
# ================================
# 🔥 FIX: EARLIER TREND DETECTION (REPLACED BREAKOUT)
# ================================
        ...
        try:
            ...
            async with websockets.connect(DERIV_WS, ping_interval=20) as ws:
                ...
                async for msg in ws:
                    ...
                    direction = early_trend(prices[pair])  # 🔥 replaced breakout
                    ...
                    if not mid_trend_filter(prices[pair], direction):  # 🔥 NEW
                        continue
